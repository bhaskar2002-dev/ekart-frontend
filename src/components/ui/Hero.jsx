...
const Hero = () => {
  return (
    <section className='bg-linear-to-r from-blue-600 to-purple-600 text-white py-27'>
        <div className='max-w-7xl mx-auto px-4'>
         <div className='grid md:grid-cols-2 gap-8 items-center'>
            <div>
                <h1 className='text-4xl md:text-6xl font-bold mb-4'>Latest Electronics at Best Prices</h1>
                <p className='text-xl mb-6 text-blue-100'>Discover cutting-edge technology with unbeatable deals on smartphones,laptopsand more.</p>
            ...
            <div className='relative'>
              <img src= "/Hero5.png" alt ="" width={600} height ={500} className='rounded-lg shadow-2xl'/>
            </div>
            </div>   
        </div>
    </section>
