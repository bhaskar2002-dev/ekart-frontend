      ...
      <div className="w-full h-full aspect-square overflow-hidden">
        {loading ? (
          ...
          onClick={()=>navigate(`/products/${product._id}`)}
            ...
            alt=""
            className="w-full h-full transition-transform duration-800 hover:scale-105 cursor-pointer"
          />
        )}
      </div>
      {loading ? (
        ...
        <div className="px-2 space-y-1">
          ...
          <Button onClick={()=> addToCart(product._id)}  className="bg-blue-600 mb-3 w-full">
            <ShoppingCart />
            Add to Cart
          </Button>
        </div>
