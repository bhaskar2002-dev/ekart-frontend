    ...
    <div className= 'flex justify-center  items-center   min-h-screen bg-blue-100'>
      ...
      <Card className="w-full max-w-sm">
        ...
        <CardFooter className="flex-col gap-2">
          <Button onClick={submitHandler} type="submit" className="w-full cursor-pointer bg-blue-600 hover:bg-blue-500">
          {loading? <><Loader2 className="h-4 w-4 animate-spin mr-2"/>Please wait</>:'Login'}
          </Button>
          <p className='text-gray-700 text-sm'>Don't have an Account? <Link to={'/signup'} className='hover:underline cursor-pointer text-blue-800'>Signup</Link></p>
        </CardFooter>
      </Card>
    </div>
  )
