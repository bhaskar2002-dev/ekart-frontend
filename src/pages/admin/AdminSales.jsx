...
const AdminSales = () => {
  ...
  console.log("Sales Data:", stats.salesByDate);
  ...
  return (
   ...
   <div className='p-6 grid gap-6 lg:grid-cols-4'>
    ...
    <Card className="bg-blue-500 text-white  shadow">
      ...
      <CardContent className="text-1xl font-bold">{stats.totalSales}</CardContent>
    </Card>
    ...
    <Card className='lg:col-span-4'>
      ...
      <CardContent style={{height:300}}>
         ...
         <YAxis/>
         <Tooltip/>
         <Area type="monotone" dataKey="amount" stroke="#60A5FA" fill='#60A5FA'/>
         </AreaChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
