...
const AdminUsers = () => {
  ...
  console.log(users);
  return (
    <div className='pl-87.5 py-30 pr-25 mx-auto px-5'>
          ...
          filteredUsers.map((user, index)=>{
            return <div key={index} className='bg-blue-100 p-5 rounded-lg'>
              <div className='flex items-center gap-2'>
                <img src={user?.profilePic || UserLogo} alt="" className='rounded-full w-16 aspect-square object-cover border border-blue-600' />
                <div>
